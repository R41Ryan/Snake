...
ButtonUI::ButtonUI(Coordinates p, std::string t, Vector2D<int> s, const char* fontFileName, int fs, bool f,
	Vector3D<int> tc, Vector3D<int> oc, Vector3D<int> bc, Vector3D<int> hc)
{
	position = p;
	text = t;
	size = s;
